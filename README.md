...
[![deploy](https://github.com/baijinming97/homepage/actions/workflows/deploy.yml/badge.svg)](https://github.com/baijinming97/homepage/actions/workflows/deploy.yml)
[![demo](https://img.shields.io/badge/theme-demo-brightgreen.svg)](https://baijinming97.github.io/homepage/)
[![GitHub contributors](https://img.shields.io/github/contributors/baijinming97/homepage.svg)](https://github.com/baijinming97/homepage/graphs/contributors/)
[![Maintainers][maintainers]](#maintainers)
[![GitHub release](https://img.shields.io/github/v/release/baijinming97/homepage)](https://github.com/baijinming97/homepage/releases/latest)
[![GitHub license](https://img.shields.io/github/license/baijinming97/homepage?color=blue)](https://github.com/baijinming97/homepage/blob/master/LICENSE)
[![GitHub stars](https://img.shields.io/github/stars/baijinming97/homepage)](https://github.com/baijinming97/homepage)
[![GitHub forks](https://img.shields.io/github/forks/baijinming97/homepage)](https://github.com/baijinming97/homepage/fork)

[![Docker Image Version](https://img.shields.io/docker/v/amirpourmand/homepage?sort=semver&label=docker%20image&color=blueviolet)](https://hub.docker.com/r/amirpourmand/homepage)
[![Docker Image Size](https://img.shields.io/docker/image-size/amirpourmand/homepage?sort=date&label=docker%20image%20size&color=blueviolet)](https://hub.docker.com/r/amirpourmand/homepage)
[![Docker Pulls](https://img.shields.io/docker/pulls/amirpourmand/homepage?color=blueviolet)](https://hub.docker.com/r/amirpourmand/homepage)

A simple, clean, and responsive [Jekyll](https://jekyllrb.com/) theme for academics.
If you like the theme, give it a star!

[![Preview](https://raw.githubusercontent.com/baijinming97/homepage/master/assets/img/homepage-preview.png)](https://baijinming97.github.io/homepage/)
...
<td>Academics</td>
<td>
<a href="https://maruan.baijinming97.com" target="_blank">★</a>
...
[![Google PageSpeed](https://raw.githubusercontent.com/baijinming97/homepage/master/assets/img/pagespeed.svg)](https://pagespeed.web.dev/report?url=https%3A%2F%2Fbaijinming97.github.io%2Fal-folio%2F&form_factor=desktop)
...
Starting version [v0.3.5](https://github.com/baijinming97/homepage/releases/tag/v0.3.5), **al-folio** will automatically re-deploy your webpage each time you push new changes to your repository! :sparkles:
    ...
    steps:
      ...
      - name: actions-template-sync
        ...
        with:
          ...
          source_repo_path: baijinming97/homepage
...
$ git remote add upstream https://github.com/baijinming97/homepage.git
$ git fetch upstream
$ git rebase v0.9.0
```
...
If you have a different question, please ask using [Discussions](https://github.com/baijinming97/homepage/discussions/categories/q-a).
...
1. **Q:** After I create a new repository from this template and setup the repo, I get a deployment error.
   ...
   **A:** Yes, if you are using release `v0.3.5` or later, the website will automatically and correctly re-deploy right after your first commit.
   ...
   Make sure to follow [deployment instructions](https://github.com/baijinming97/homepage#deployment) in the previous section.
   (Relevant issue: [209](https://github.com/baijinming97/homepage/issues/209#issuecomment-798849211).)
...
2. **Q:** I am using a custom domain (e.g., `foo.com`).
   ...
   **A:** You need to add `CNAME` file to the `master` or `source` branch of your repository.
   ...
   (Relevant issue: [130](https://github.com/baijinming97/homepage/issues/130).)
...
3. **Q:** My webpage works locally.
   ...
   **A:** Make sure you followed through the [deployment instructions](#deployment) in the previous section.
   ...
   (Related issue: [1438](https://github.com/baijinming97/homepage/issues/1438).)
...
4. **Q:** My webpage works locally.
   ...
   **A:** Make sure to correctly specify the `url` and `baseurl` paths in `_config.yml`.
   ...
   [for your browser to fetch again the site stylesheet](https://github.com/baijinming97/homepage/issues/1398#issuecomment-1609518404).
...
<p align="center"><img src="https://raw.githubusercontent.com/baijinming97/homepage/master/assets/img/publications-screenshot.png" width=800></p>
...
<p align="center"><img src="https://raw.githubusercontent.com/baijinming97/homepage/master/assets/img/projects-screenshot.png" width=700></p>
...
<p align="center"><a href="https://baijinming97.github.io/homepage/blog/2021/distill/" target="_blank"><img src="https://raw.githubusercontent.com/baijinming97/homepage/master/assets/img/distill-screenshot.png" width=700></a></p>

For more details on how to create distill-styled posts using `<d-*>` tags, please refer to [the example](https://baijinming97.github.io/homepage/blog/2021/distill/).
...
<p align="center">
<a href="https://baijinming97.github.io/homepage/blog/2015/math/" target="_blank"><img src="https://raw.githubusercontent.com/baijinming97/homepage/master/assets/img/math-screenshot.png" width=400></a>
<a href="https://baijinming97.github.io/homepage/blog/2015/code/" target="_blank"><img src="https://raw.githubusercontent.com/baijinming97/homepage/master/assets/img/code-screenshot.png" width=400></a>
</p>
...
<p align="center">
  <a href="https://baijinming97.github.io/homepage/projects/1_project/">
    <img src="https://raw.githubusercontent.com/baijinming97/homepage/master/assets/img/photos-screenshot.png" width="75%">
  </a>
</p>
...
<table>
  <tbody>
    <tr>
      <td align="center" valign="top" width="14.28%"><a href="http://maruan.baijinming97.com"><img src="https://avatars.githubusercontent.com/u/2126561?v=4" width="100px;" alt=""/><br /><sub><b>Maruan</b></sub></a></td>
...
The theme is available as open source under the terms of the [MIT License](https://github.com/baijinming97/homepage/blob/master/LICENSE).
